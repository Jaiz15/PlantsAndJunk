...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(PlantsJunk.MOD_ID, name), item);
    }
    ...
    public static final Item HANGING_ROTTEN_SIGN = registerItem("rotten_hanging_sign", new HangingSignItem(ModBlocks.HANGING_ROTTEN_SIGN, ModBlocks.WALL_HANGING_ROTTEN_SIGN, new FabricItemSettings().maxCount(16)));
