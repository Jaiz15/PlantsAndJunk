...
public class DragonflyRenderer extends MobEntityRenderer<DragonflyEntity, DragonFly<DragonflyEntity>> {
    ...
    public static final Map<DragonflyVariant, Identifier> DRAGONFLY_VARIANT =
            Util.make(Maps.newEnumMap(DragonflyVariant.class), (map) -> {
                map.put(DragonflyVariant.AQUA_YELLOW, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_aqua_2.png"));
                map.put(DragonflyVariant.AQUA, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly.png"));
                map.put(DragonflyVariant.GRAY, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_grey.png"));
                map.put(DragonflyVariant.BLUE, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_blue.png"));
                map.put(DragonflyVariant.ORANGE, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_orange.png"));
                map.put(DragonflyVariant.RED, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_red_2.png"));
                map.put(DragonflyVariant.RED_GREEN, new Identifier(PlantsJunk.MOD_ID, "textures/entity/dragonfly/dragonfly_red.png"));
            });
