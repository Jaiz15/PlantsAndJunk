...
public class ModBlocks {
    ...
    public static final Identifier ROTTEN_SIGN_TEXTURE = new Identifier(PlantsJunk.MOD_ID, "entity/signs/rotten");
    public static final Identifier ROTTEN_HANGING_SIGN_TEXTURE = new Identifier(PlantsJunk.MOD_ID, "entity/signs/hanging/rotten");
    public static final Identifier ROTTEN_HANGING_GUI_SIGN_TEXTURE = new Identifier(PlantsJunk.MOD_ID, "textures/gui/hanging_signs/rotten");

    public static final Block STANDING_ROTTEN_SIGN = Registry.register(Registries.BLOCK, new Identifier(PlantsJunk.MOD_ID, "rotten_standing_sign"),
            new TerraformSignBlock(ROTTEN_SIGN_TEXTURE, FabricBlockSettings.copyOf(Blocks.OAK_SIGN)));

    public static final Block WALL_ROTTEN_SIGN = Registry.register(Registries.BLOCK, new Identifier(PlantsJunk.MOD_ID, "rotten_wall_sign"),
            new TerraformWallSignBlock(ROTTEN_SIGN_TEXTURE, FabricBlockSettings.copyOf(ModBlocks.STANDING_ROTTEN_SIGN)));

    public static final Block HANGING_ROTTEN_SIGN = Registry.register(Registries.BLOCK, new Identifier(PlantsJunk.MOD_ID, "rotten_hanging_sign"),
    ...
    public static final Block WALL_HANGING_ROTTEN_SIGN = Registry.register(Registries.BLOCK, new Identifier(PlantsJunk.MOD_ID, "rotten_wall_hanging_sign"),
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(PlantsJunk.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(PlantsJunk.MOD_ID, name),
